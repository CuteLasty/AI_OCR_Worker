...
from analyzers.aa8.date_str_utils import generate_YMDD, generate_CHT_YYMM
...
class AK3_AU_TW_SG_CL1_Retail_Label(BaseLabelAnalyzer):
    ...
    def analyze(self, ocr_results, image_width, image_height):
        ...
        try:
            ...
            ocr_results_copy1 = find_text_and_process_date_str(
                ocr_results_copy, '製造日期', date_str_CHT_YMMM, analysis)
